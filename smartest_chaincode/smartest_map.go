...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	// Create MetaContracts array
	emptyArray := []SmartestContract{}
	arrayAsBytes, _ := json.Marshal(emptyArray)
	err := stub.PutState("MetaContracts", arrayAsBytes)
	if err != nil {
		return nil, errors.New("Failed creating empty MetaContracts.")
	}
...
func (t *SimpleChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	case "getMetaContracts":
		...
		*/
		...
		metaContractsAsBytes, err := stub.GetState("MetaContracts")
		if err != nil {
			return nil, errors.New("Failed to get MetaContracts")
		}
		var metaContracts []SmartestContract
		json.Unmarshal(metaContractsAsBytes, &metaContracts) //un stringify it aka JSON.parse()

		return metaContracts, nil
